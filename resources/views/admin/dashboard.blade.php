                            ...
                            <thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="btn btn-sm btn-primary waves-effect" target="_blank" href="{{ route('post.details',$item->slug) }}">View</a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                        </table>
