                ...
                <div class="body">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane fade in active" id="profile_with_icon_title">
                            <form method="POST" action="{{ route('admin.settings.profile.update',Auth::user()->id) }}"
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                @if(Storage::disk('public')->exists('user/', Auth::user()->image))
                                                    <img src="{{ asset('storage/user/'. Auth::user()->image) }}" style="border-radius:60%" alt="profile image" width="50" height="40">
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="password_with_icon_title">
                                <form method="POST" action="{{ route('admin.settings.change.password') }}" class="form-horizontal">
                                @csrf
                                @method('PUT')
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
