                ...
                <div class="body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tbody>
                                @foreach ($posts as $commts)
                                    @foreach ($commts->comments as $item)
                                    <tr>
                                            ...
                                            <div class="media">
                                                <div class="media-right">
                                                    <a href="{{ route('post.details',$item->post->slug) }}" target="_blank">
                                                        @if(
                                                            Storage::disk('public')->exists('post/',$item->post->photo))
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('author.comment.delete',$item->id) }}"  id="delete" class="btn btn-danger btn-xs">
