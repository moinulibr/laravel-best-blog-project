                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <input value="{{ old('title')??$post->title }}" name="title" type="text" id="title" class="form-control" placeholder="Post title">
                        ...
                        <label for="description">Current Featured Image</label>
                        <div class="form-group">
                            <div class="form-line">
                                <img src="{{ asset('storage/post/'.$post->photo) }}" alt="" width="160" height="60">
                            </div>
                        </div>
                        <input {{ $post->status == 1 ?'checked' : '' }} type="checkbox" id="publish" class="filled-in" name="status" value="1">
                            ...
                            <div class="form-line {{ $errors->has('categories') ? 'focused error' : '' }}">
                                <select name="categories[]" id="category" data-live-search="true" multiple class="form-control show-tick">
                                    ...
                                    <option @foreach ($post->categories as $postCategory)
                                       {{  $postCategory->id == $item->id ?'selected':'' }}
