...
<div class="container-fluid">
    <div class="block-header">
       <a href="{{ route('author.post.create') }}" class="btn btn-primary">Add New Post</a>
    </div>
                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('author.post.show',$item->id) }}" class="btn btn-info btn-xs">
                                            <i class="material-icons">visibility</i>
                                        </a>
                                        <a href="{{ route('author.post.edit',$item->id) }}" class="btn btn-primary btn-xs">
                                            <i class="material-icons">edit</i>
                                        </a>

                                        <a href="{{ route('author.post.delete',$item->id) }}" id="delete" class="btn btn-danger btn-xs">
